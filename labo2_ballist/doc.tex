...
\begin{document}
    ...
    \begin{itemize}
        \item Première expérience : pour la distance finale, nous avons effectué cinq tirs avec les mêmes spécifications, et nous avons utilisé les formules statistiques "moyenne" et "écart-type".
    \begin{center}
        \vspace{-\baselineskip}
        \begin{minipage}{0.3\linewidth}
            \begin{empheq}[box={\mymath}]{equation*}
